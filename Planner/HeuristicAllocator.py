...
class HeuristicAllocator:
    def __init__(self, env):
        ...
        self.discharging_wakeup = simpy.Store(self.env)
        self.waiting_job = []
    ...
    def reheating(self, name, job):
        HeatingFurnace.recharging_wakeup.put(name, job)
    ...
    def get_next_press_job(self):
        ...
        self.discharging_wakeup.put([target_job['properties']['current_equip'], target_job])
        return target_job
    ...
    def get_next_treatment_job(self):
        ...
        self.discharging_wakeup.put([target_job_list[0]['properties']['current_equip'], target_job_list[0]])
